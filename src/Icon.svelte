<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 245.562 245.562" style="enable-background:new 0 0 245.562 245.562;" class="w-10 h-10 fill-current text-white p-2 bg-teal-400 rounded-full" xml:space="preserve">
